/**
 * Project Config File API
 *
 * POST /api/project-config-file - Read configuration/project-configuration.yaml
...
export const POST: APIRoute = async ({ request }) => {
  try {
    ...
    return new Response(
      JSON.stringify({ error: 'Failed to load project config file' }),
